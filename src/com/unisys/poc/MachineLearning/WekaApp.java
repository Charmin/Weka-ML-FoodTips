...
public class WekaApp {
	...
	public Response postCordinates(@FormParam("param2") String longitude,@FormParam("param1") String latitude)
    {
		apiWeather = new OpenWeatherApi();
		...
		resource.setOutlook(outlook);	    
		System.out.println("The outlook at "+location+" today"+ outlook);
